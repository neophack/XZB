...
#define BOARD_MODEL_URL		"http://xzb.xunlei.com/"
...
#define  BOARD_GPIO_LED_ROUTER	7
#define  BOARD_GPIO_PWR_USB	11
#undef  BOARD_GPIO_PWR_USB2	//9
#define  BOARD_GPIO_PWR_USB_ON	1
#undef BOARD_HAS_5G_11AC	//1
#undef BOARD_NUM_ANT_5G_TX	//2
#undef BOARD_NUM_ANT_5G_RX	//2
#undef BOARD_NUM_ANT_2G_TX	//2
#undef BOARD_NUM_ANT_2G_RX	//2
